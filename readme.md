...
- **Prefer answering a few questions** — the [setup wizard](https://simoncropp.github.io/SponsorCheck/) generates tailored, copy-pasteable configuration for either role.
