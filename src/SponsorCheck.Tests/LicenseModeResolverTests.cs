public class LicenseModeResolverTests
{
    ...
    {
        var d = LicenseModeResolver.Resolve("true", null, NoSponsors(), null, "ThePkg");
    ...
    {
        var d = LicenseModeResolver.Resolve("false", null, NoSponsors(), null, "ThePkg");
        await Assert.That(d).IsTypeOf<LicenseDecision.MissingConfig>();
    }
    ...
    {
        var d = LicenseModeResolver.Resolve(null, null, Sponsors(("GitHubSponsors", "alice")), null, "ThePkg");
    ...
    {
        var d = LicenseModeResolver.Resolve(null, "2099-12", NoSponsors(), null, "ThePkg");
    ...
    {
        var d = LicenseModeResolver.Resolve(null, "2099-12", Sponsors(("GitHubSponsors", "alice")), null, "ThePkg");
    ...
    {
        var d = LicenseModeResolver.Resolve("true", "2099-12", Sponsors(("Polar", "alice")), null, "ThePkg");
        var conflict = (LicenseDecision.ConflictingModes)d;
